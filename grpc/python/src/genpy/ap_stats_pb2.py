...
_STATSTIMEINTERVAL = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AP_STATS_MIN_TIME_INTERVAL', index=2, number=30,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_APCLIENTENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='UserAgent', full_name='cheetah.APClientEntry.UserAgent', index=30,
